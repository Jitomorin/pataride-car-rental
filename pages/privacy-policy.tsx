  ...
  return (
    <div className="privacy-policy-container">
      ...
      <Layout preview={preview} loading={loading}>
        <PrivacyPolicyPageWrapper theme={theme}>
          <div
          ...
          >
            ...
            {preview && !doc ? (
              ...
              <Wrapper>
                <ArticleWrapper>
                  {policyList.map((doc) => (
                    <PrivacyPolicyContainer theme={theme}>
                      <PrivacyPolicyHeader
                        title={doc?.title}
                        date={doc?.date}
                      />
...
`;
const PrivacyPolicyContainer = styled.div<{ theme: string }>`
  display: flex;
...
`;
const PrivacyPolicyPageWrapper = styled(Container)<{ theme: string }>`
  ${(props) =>
    props.theme !== "light"
